...
(function($PS) {
  ...
  var processCommand = function (e) {
      return function (command) {
          ...
          var executeCommand = function (behaviour) {
              return function (acc) {
                  return Data_Exists.runExists(runBehaviour(acc))(behaviour);
              };
          };
          return Data_Foldable.foldr(Data_List_Types.foldableList)(executeCommand)({
              id: e.id,
              location: e.location,
              width: e.width,
              height: e.height,
  ...
  var performChecks = function (entities) {
      return function (target) {
          return Data_Foldable.foldl(Data_List_Types.foldableList)(collideEntities)(target)(entities);
      };
  };
  ...
  var applyPhysics = function (v) {
      return {
          entities: Data_Functor.map(Data_List_Types.functorList)(performChecks(v.entities))(v.entities),
          world: v.world
      };
  };
  var tick = function (v) {
      return applyPhysics({
          entities: Data_Functor.map(Data_List_Types.functorList)(function (e) {
              return processCommand(e)(Tick.value);
          })(v.entities),
          world: v.world
      });
  };
