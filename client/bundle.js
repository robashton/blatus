...
(function($PS) {
  ...
  var render = function (v) {
      return function (v1) {
          return function (ctx) {
              var topTile = Data_Int.floor((v.top - v1.world.y) / tileHeight);
              var rightTile = Data_Int.ceil((v.right - v1.world.x) / tileWidth);
              var leftTile = Data_Int.floor((v.left - v1.world.x) / tileWidth);
              var horizontal = Data_List.range(leftTile)(rightTile);
              var bottomTile = Data_Int.ceil((v.bottom - v1.world.y) / tileHeight);
              ...
              return function __do() {
                  ...
                  var v9 = Data_Traversable.traverse(Data_List_Types.traversableList)(Effect.applicativeEffect)(function (tileX) {
                      ...
                      return function __do() {
                          var v9 = Graphics_Canvas.moveTo(ctx)(lineX)(v.top)();
                          var v10 = Graphics_Canvas.lineTo(ctx)(lineX)(v.bottom)();
                  ...
                  var v10 = Data_Traversable.traverse(Data_List_Types.traversableList)(Effect.applicativeEffect)(function (tileY) {
                      ...
                      return function __do() {
                          var v10 = Graphics_Canvas.moveTo(ctx)(v.left)(lineY)();
                          var v11 = Graphics_Canvas.lineTo(ctx)(v.right)(lineY)();
                          return Data_Unit.unit;
                      };
                  })(vertical)();
  ...
  var sendCommand = function (id) {
      return function (command) {
          return function (v) {
              return {
                  entities: Data_Functor.map(Data_List_Types.functorList)(function (e) {
                      var $32 = Data_Eq.eq(eqEntityId)(e.id)(id);
                      if ($32) {
